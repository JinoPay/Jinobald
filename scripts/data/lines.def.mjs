...
export const LINE_DEFS = [
  ...
  },
  {
    ...
    stations: `장암 도봉산 수락산 마들 노원 중계 하계 공릉 태릉입구 먹골 중화 상봉 면목 사가정
      용마산 중곡 군자 어린이대공원 건대입구 자양 청담 강남구청 학동 논현 반포 고속터미널
  ...
  },
  {
    ...
    stations: `일산 풍산 백마 곡산 대곡 능곡 김포공항 원종 부천종합운동장 소사 소새울 시흥대야
      신천 신현 시흥시청 시흥능곡 달미 선부 초지 시우 원시`,
  },
  {
  ...
  },
  {
    ...
    note: '검단호수공원~국제업무지구 (2025년 6월 검단연장 포함).',
    stations: `검단호수공원 신검단중앙 아라 계양 귤현 박촌 임학 계산 경인교대입구 작전 갈산 부평구청 부평시장 부평 동수
...
export const ALIASES = {
  서울역: ['서울'],
  총신대입구: ['이수', '총신대입구(이수)'],
  // 7호선 이수역 — 4호선 총신대입구와 같은 환승역. 공공데이터는 두 표기를 섞어 씁니다.
  이수: ['총신대입구', '총신대입구(이수)'],
  // 2024년 개명. 옛 이름으로 검색해도 찾히게 둡니다.
  자양: ['뚝섬유원지', '자양(뚝섬한강공원)', '뚝섬한강공원'],
  // 2020년 개명 (서해선).
  시우: ['원곡'],
  '전대.에버랜드': ['전대에버랜드', '에버랜드'],
  '시청.용인대': ['시청용인대', '용인시청'],
