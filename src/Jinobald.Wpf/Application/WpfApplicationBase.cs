...
public abstract class WpfApplicationBase<TMainWindow, TSplashWindow> : System.Windows.Application
    ...
    where TSplashWindow : Window, ISplashScreen, new()
{
    ...
    protected virtual void ConfigureExceptionHandling()
    {
        ...
        // WPF Dispatcher 예외 처리
        DispatcherUnhandledException += OnDispatcherUnhandledException;
    }

    /// <summary>
    ///     WPF Dispatcher에서 처리되지 않은 예외 발생 시 호출
    /// </summary>
